...
class Settings(BaseSettings):
    ...
    # so that whoever can reach the domain after install can't race-claim the
    # first admin account. Empty string disables the check (matches the legacy
    # behavior so an in-place upgrade of an already-set-up org still works).
    BOOTSTRAP_TOKEN: str = ""
